...
export default function WidowsModal({ open, data, loading, onClose }: WidowsModalProps) {
  if (!open) return null;
  ...
  function exportToExcel() {
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'كشف الأرامل');
    XLSX.writeFile(wb, 'كشف_الأرامل.xlsx');
  }
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-4xl max-h-[85vh] flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200">
          <h2 className="text-lg font-bold text-slate-800">🕊️ كشف الأرامل</h2>
